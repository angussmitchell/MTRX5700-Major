...
# previous_mood = drone_dancer.dance_moods.MOOD_GO_HARD
...
dancer.enqueue_move(dancer.dance_moves.MOVE_SPIN_CLOCKWISE, 8.5)


dancer.enqueue_move(dancer.dance_moves.MOVE_SPIN_CLOCKWISE_UP, 3)

# dancer.enqueue_move(dancer.dance_moves.MOVE_FLIP, 1)
